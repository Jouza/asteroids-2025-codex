  ...
  const dictionaries = {
    en: {
      ...
      "help.section.pilot_identity_hint":
        "In start/game over/victory overlays, use unified Run setup: <strong>Up/Down</strong> select row (Mode/Pilot/Ship), <strong>Left/Right</strong> change value. Identity adds small stat flavor bonuses.",
