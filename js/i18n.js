  ...
  const dictionaries = {
    en: {
      ...
      "index.controls_compact_html":
        "<strong>Core:</strong> Left/Right rotate, Up thrust, Space fire, Shift boost, V dash, X secondary, C utility.<br><strong>Setup:</strong> Enter start/restart, F flight model, G audio, H help, B/N perf.",
