(() => {
  ...
  const dictionaries = {
    en: {
      ...
      "overlay.end_summary.tab.overview": "OVERVIEW",
      "overlay.end_summary.tab.drops_damage": "DROPS + DAMAGE",
      "overlay.end_summary.tab.timeline_faction": "TIMELINE + FACTION",
      ...
      "overlay.end_summary.drop_title": "Drop Highlights",
      "overlay.end_summary.no_drops": "No drops recorded in this run.",
      "overlay.end_summary.drop_row": "[{rarity}] {name} ({slot}) | {source} S{sector}",
      ...
      "overlay.end_summary.timeline_row": "S{sector} {label} | +{score} score +{credits}cr | hits {hits} | SH {sh} HU {hu}",
      ...
      "index.audio_modal.touch_smoothing": "Aim smoothing",
      "index.audio_modal.touch_smoothing.low": "Low",
      "index.audio_modal.touch_smoothing.default": "Default",
      "index.audio_modal.touch_smoothing.high": "High",
