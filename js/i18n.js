(() => {
  ...
  const dictionaries = {
    en: {
      ...
      "render.hangar.bounty_title": "Bounty Board S{sector} ({used}/{max} rerolls)",
      ...
      "help.section.pilot_identity_hint":
        "In start/game over/victory overlays, use unified Run setup: <strong>Up/Down</strong> select row (Mode/Difficulty/Pilot/Ship/Flight), <strong>Left/Right</strong> change value. Hover pilot name for reference tooltip. Identity adds small stat flavor bonuses.",
