(() => {
  ...
  const dictionaries = {
    en: {
      ...
      "overlay.identity_select": "Pilot and ship identity",
      "overlay.identity_pilot": "Pilot",
      "overlay.identity_ship": "Ship",
      "overlay.identity_select_hint": "Up/Down pilot, A/D ship frame",
      ...
      "help.section.pilot_identity_hint":
        "In start/game over/victory overlays, choose your identity with <strong>Up/Down</strong> for pilot and <strong>A/D</strong> for ship frame. Identity adds small stat flavor bonuses.",
      ...
      "help.card.identity_pilots.name": "Pilot Roster (4)",
      "help.card.identity_pilots.tag": "Identity layer",
      "help.card.identity_pilots.line":
        "Needle Voss (precision cooldown+crit), Graveline Kade (shield sustain + collision tolerance), Rook-86 (heavy hull/shield), Blink Serrat (mobility burst).",
      ...
      "identity.pilot.needle_voss.callsign": "Needle Voss",
      "identity.pilot.graveline_kade.callsign": "Graveline Kade",
      "identity.pilot.rook_86.callsign": "Rook-86",
      "identity.pilot.blink_serrat.callsign": "Blink Serrat",
