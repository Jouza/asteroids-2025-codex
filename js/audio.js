  ...
  class AudioSystem {
    constructor() {
      ...
      this.biomeAudioProfiles = {
        ...
        neon_nebula: { warningSoundId: "warning_neon_nebula", stinger: { a: 280, b: 460, c: 700 } },
        dust_expanse: { warningSoundId: "warning_dust_expanse", stinger: { a: 160, b: 220, c: 300 } }
      };
      this.soundDefs = {
        ...
        warning_neon_nebula: { priority: 5, cooldownMs: 280, cooldownAlias: "warning" },
        warning_dust_expanse: { priority: 5, cooldownMs: 280, cooldownAlias: "warning" },
    ...
    play(soundId, options = {}) {
      ...
      else if (resolvedSoundId === "warning_neon_nebula") this.playTone(startAt, 0.18, 760, 520, "sawtooth", 0.054, def.priority);
      else if (resolvedSoundId === "warning_dust_expanse") this.playTone(startAt, 0.2, 260, 180, "triangle", 0.052, def.priority);
